...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    {isWordmark ? <WordmarkApproval /> : isLogoTest ? <LogoPlayground /> : isCaseCheckerApp ? <CaseCheckerApp /> : isCaseChecker ? <CaseCheckerPage /> : isTruthOrLie ? <TruthOrLiePage /> : isResources ? <ResourcesPage /> : isSecurity ? <SecurityPage /> : <App />}
  </StrictMode>,
)
